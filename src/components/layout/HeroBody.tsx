    ...
    return(
        <>
            ...
            <div className="absolute inset-0 z-10 flex flex-col justify-center text-white px-4">
                <h1 className="text-4xl sm:text-8xl md:text-8xl lg:text-9xl font-extrabold self-start ml-4 sm:ml-8 md:ml-1 xl:ml-44 2xl:ml-96">
                    Take it to
                </h1>
                <h1 className="text-4xl sm:text-8xl md:text-8xl lg:text-9xl font-extrabold self-end mr-4 sm:mr-8 md:mr-1 xl:mr-44 2xl:mr-96 text-right">
                    the{" "}
